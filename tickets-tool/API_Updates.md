...
This document describes the database and API changes made to `tickets-tool` (formerly `feedback-tool`) that the GUI should be updated to support.
...
- Format: `tk-` followed by 8 hex characters (e.g., `tk-a1b2c3d4`)
...
- Always display `ticket_id` (e.g., `tk-a1b2c3d4`) as the primary identifier
