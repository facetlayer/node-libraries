...
export function lexifyString(text: string, settings: LexerSettings = {}): LexedText {
...
export function lexStringToIterator(str: string, settings: LexerSettings = {}): TokenIterator {
    return new TokenIterator(lexifyString(str, settings));
}
